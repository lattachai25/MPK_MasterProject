...
<div id="mainNav" class="menu-area fixed-top" >
        <div class="row">
            <nav class="navbar navbar-light navbar-expand-lg mainmenu">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-top:30px;">
                    ...
                    <img src="{{asset('img/icon_menu/MPK_logo-02.png')}}" width="150" alt="" style="margin-top:-20px; margin-top: -7px;">
                    </a>
                        ...
                        <li class="dropdown {{ (request()->is('','select_your_bike','category','bike_for_sell')) ? 'active' : '' }}">
                            ...
                            <li class="{{ (request()->is('bike_for_sell')) ? 'active' : '' }}"><a href="{{ route('bike_for_sell.index') }}">BIKE FOR SELL</a></li>
                            </ul>
                        </li>
                        ...
                        <li>  
                        <a href="{{ route('Contact.index') }}"><i class="fas fa-map-marker-alt" style="margin-top:20px;" class="{{ (request()->is('Register')) ? 'active2' : '' }}"></i></a>
                        </li>
